      ...
      <div>
          ...
          <div className="content">
            ...
            <div className="section_content">
              ...
              <h3 className="Explanation">
                <a href="https://itunes.apple.com/us/app/ice-cream-explosion/id1205754650?mt=8" target="_blank" rel="noopener noreferrer">
                  Ice Cream Explosion
                </a>{' '}
                is the first app I released to the App Store. It is an original arcade style game that I created the{' '}
                <a href="https://soundcloud.com/lukemorse/sets/ice-cream-explosion-soundtrack" target="_blank" rel="noopener noreferrer">
                  music
                </a>{' '}
                and sound FX for.
              </h3>
            ...
            <div className="section_content">
              <a href="https://itunes.apple.com/app/id1226528959" className="image" target="_blank" rel="noopener noreferrer">
        ...
        <ScrollAnimation animateIn="fadeInUp" animateOnce={true}>
          <div className="content">
            ...
            <div className="section_content">
              <a href="https://yayconifers.bandcamp.com/album/mt-pilchuck" className="image" target="_blank" rel="noopener noreferrer">
